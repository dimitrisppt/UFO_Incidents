...
/**
 * This class is responsible for all the icons that are displayed
 * on different components in the game's panel.
 * @author Dimitris Papatheodoulou
 *
 */
public class GameIconCreator {

	// Declaring fields for the images
	...
	// Declaring array of BufferedImage
	...
	/**
	 * The constructor initialises all the BufferedImage fields with their corresponding image
	 * creates a new array of BufferedImage with 8 positions and adds ufo icons to it. Also initialises
	...
	public GameIconCreator(GameModel gameModel) throws IOException {
		...
		// Reads images for all the game's items.
		...
		// Reads images for all the ufo icons
		...
		// Creates a new array of BufferedImage with 8 positions to add the ufo icons.
